...
Similarity-weighted superposition
Logit emergence from superposition
Collapse through sampling
...
Hub participation is never automatic. No node is elevated to relay status without explicit local intent.
